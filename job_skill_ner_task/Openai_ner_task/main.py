...
from langchain_preprocessing_func import append_dict_to_csv, process_string
...
job_parsed = pd.read_csv(
    "job_classification/openai_job_description_extraction/data/meet_job_2023-06-29.csv"
)
